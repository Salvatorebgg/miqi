...
| 数学 | 五个进阶阶段 17 节课（高中衔接→预备微积分→一元微积分→多元微积分→线性代数），全部课程直接开放，每课含原理讲解（KaTeX）、交互式函数图像、详细讲义、公式卡片、常见误区、习题与解析、测验、视频资料 |
| 英语 | 间隔重复背单词（100+ 雅思词汇，含音标与英/美发音朗读）、情景理解、英文新闻、论文摘要精读，做完题目可查看全文翻译（双语逐段对照） |
